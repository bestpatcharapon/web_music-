...
function App() {
  ...
  // Backend URL - Production Railway URL
  const BACKEND_URL =
    process.env.REACT_APP_API_URL ||
    "https://webmusic-production.up.railway.app";
  ...
  return (
    <div className="App">
      ...
      <header className="App-header">
        <h1>Mood to Music</h1>
        <p>
          Tell us how you feel, and we'll recommend the perfect songs for you
        </p>
      </header>
        ...
        {analysis && !isLoading && recommendations.length > 0 && (
          <div className="analysis-results">
            ...
            <div className="emotion-tags">
              ...
              <span className="emotion-tag sentiment">
                {analysis.sentiment}
              </span>
            </div>
